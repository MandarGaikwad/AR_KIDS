...
public class Domestic extends AppCompatActivity {
    ...
    String[] myBooks;
    int t;
    private static final String SOUNDFILE_PATH = "domestic_sounds";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myBooks = res.getStringArray(R.array.domesticanim);
        final ArrayList<CustomClass> items = new ArrayList<>();
        for (int i=0;i<9;i++ )
        {
            items.add(new CustomClass(myBooks[i]));
        }
        CustomAdapter4 customAdapter = new CustomAdapter4(Domestic.this,items);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
              ...
              //  Toast.makeText(Domestic.this, "I LOVE To DIE..!!! -- "+string_alphabate +"\n position "+ t, Toast.LENGTH_SHORT).show();
                switch (position) {
                    case 0: playSoundFromAssets(position);
                        Intent i=new Intent(Domestic.this,ARcoreH.class);
                        startActivity(i);
                        break;
                    case 1: playSoundFromAssets(position);
                        Intent in=new Intent(Domestic.this,ARcoreCat.class);
                        startActivity(in);
                        break;
                    case 2: playSoundFromAssets(position);
                        Intent in0=new Intent(Domestic.this,ARcoreDuck.class);
                        startActivity(in0);
                        break;
                    case 3: playSoundFromAssets(position);
                        Intent in1=new Intent(Domestic.this,ArcoreHen.class);
                        startActivity(in1);
                        break;
                    case 4: playSoundFromAssets(position);
                        Intent in2=new Intent(Domestic.this,ARcoreCamel.class);
                        startActivity(in2);
                        break;
                    case 5: playSoundFromAssets(position);
                        Intent in3=new Intent(Domestic.this,ARcoreSheep.class);
                        startActivity(in3);
                        break;
                    case 6: playSoundFromAssets(position);
                        Intent in4=new Intent(Domestic.this,ARcorePig.class);
                        startActivity(in4);
                        break;
                    case 7: playSoundFromAssets(position);
                        Intent in5=new Intent(Domestic.this,ARcoreCow.class);
                        startActivity(in5);
                        break;
                    case 8: playSoundFromAssets(position);
                        Intent in6=new Intent(Domestic.this,ARcoreGoat.class);
                        startActivity(in6);
                        break;
                    case 9: playSoundFromAssets(position);
                        Intent in7=new Intent(Domestic.this,ArcoreD.class);
                        startActivity(in7);
                        break;
                }
            }
